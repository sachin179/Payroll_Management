        ...
        <div class="top-bar">
            <div class="container-fluid clearfix">
                ...
                <div class="right-content float-right">
                          ...
                          <a style="color:white" href="topnotch" target="_blank">ITP</a>
            ...
            <div class="container clearfix">
                ...
                <div class="main-navigation" id="main-nav-bar">
                    <ul class=" navigation-box">
                        ...
                        <li>
                            <a href="allMedicine">List Patient</a>
                        </li>
                          <li>
                            <a href="alltest">List Test</a>
                        </li>
                         <li>
                            <a href="cbctestdetails">Add TestDetails</a>
                        </li>
                            <li>
                            <a href="addNewMedi">Add Patient</a>
                        </li>
                    ...
                    <div class="container">
                        <div class="box valign-middle">
                            <div class="content text-left">
                                <h3 data-animation="animated fadeInUp">Laboratary <br> Management</h3>
                                <p data-animation="animated fadeInDown">Hospital Management</p>
