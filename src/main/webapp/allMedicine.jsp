...
<head>
    <meta charset="UTF-8">
    <title>All Users | Laborotary Management System</title>
   ...
   <header class="site-header ">
        <div class="top-bar">
            <div class="container-fluid clearfix">
                ...
                <div class="right-content float-right">
                    <ul>
                        <a style="color:white" href="topnotch" target="_blank"></a>
                    </ul>
                </div><!-- /.left-content -->
            </div><!-- /.container-fluid -->
        </div><!-- /.top-bar -->
            ...
            <div class="container clearfix">
                ...
                <div class="main-navigation" id="main-nav-bar">
                    <ul class=" navigation-box">
                        ...
                        <li class=" current">
                            <a href="all-medicine">List Patient</a>
                        </li>
            ...
            <c:forEach items="${medicines}" var="medicine">
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-xs-12 masonary-item">
                    <div class="single-service-style-eight hvr-sweep-to-bottom">
                        <div class="img-box">
                            <img src="images/patient.png" alt="Awesome Image">
                        </div><!-- /.img-box -->
                        <div class="text-block">
                            <h3><a href="#">${medicine.username} </a></h3>
                            <p>${medicine.phone}</p>
                             <p>${medicine.nic}</p>
                              <p>${medicine.bgroup}</p>
                                <p>${medicine.dname}</p>
                            <a style="color:white" href="/edit-patient?username=${medicine.username }">Edit</a>
                            <a href="/delete-patient?id=${medicine.id }" class="read-more">Delete</a>
                        </div><!-- /.text-block -->
    ...
    <footer class="site-footer">
        ...
        <div class="bottom-footer">
            <div class="container">
                <p>&copy; Copyright <script>document.write(new Date().getFullYear())</script> by <a href="" target="_blank"></a></p>
            </div><!-- /.container -->
        </div><!-- /.bottom-footer -->
    </footer><!-- /.site-footer -->
