...
<head>
    <meta charset="UTF-8">
    <title>All Test | Laborotary Management System</title>
            ...
            <div class="container clearfix">
                ...
                <div class="main-navigation" id="main-nav-bar">
                    <ul class=" navigation-box">
                        ...
                        <li class=" current">
                            <a href="all-test">List test </a>
                        </li>
                       
                    </ul>
                </div><!-- /.navbar-collapse --><Tab>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-xs-12 masonary-item">
                    <div class="single-service-style-eight hvr-sweep-to-bottom">
                        ...
                        <div class="text-block">
                            <h3><a href="#">${test.rbc} ${test.wbc}</a></h3>
                            <p>${test.rbc}</p>
                             <p>${test.hemoglobin}</p>
                              <p>${test.mvc}</p>
                               <p>${test.mch}</p>
                            ...
                            <a style="color:white" href="/edit-test?id=${test.rbc }">Edit</a>
                            <a href="/delete-test?id=${test.id }" class="read-more">Delete</a>
                        </div><!-- /.text-block -->
