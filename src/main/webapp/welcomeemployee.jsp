            ...
            <div class="container clearfix">
                ...
                <div class="main-navigation" id="main-nav-bar">
                    <ul class=" navigation-box">
                        ...
                        <li>
                            <a href="manage">Payroll Management</a>
                        </li>
                     
                        
                          <li>
                            <a href="lab">Laborotatry</a>
                        </li>
                    ...
                    <div class="container">
                        <div class="box valign-middle">
                            <div class="content text-left">
                                <h3 data-animation="animated fadeInUp">Hospital <br> Management</h3>
                                <p data-animation="animated fadeInDown">Best Management</p>
